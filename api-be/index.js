...
const jwtSecret = 'lhct5ka9ga5nj266vgc4ajnc619cnj6'
...
app.post('/places', (req, res) => {
    ...
    const { title, address, addedPhotos,
        ...
        checkOut, maxGuests, pricePerNight } = req.body
...
app.post('/bookings', async (req, res) => {
    ...
    const { place, checkIn, checkOut,
        numberOfGuests, name, phone, pricePerNight } = req.body;

    Booking.create({
        place, checkIn, checkOut,
        numberOfGuests, name, phone, pricePerNight,
        user: userData.id,
    }).then((doc) => {
        res.json(doc);
    }).catch((err) => {
